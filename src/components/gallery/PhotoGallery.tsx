      ...
      {!loaded && !errored && (
        <div
          ...
          style={{
            ...
            inset: 0,
            background:
              "linear-gradient(90deg, #2A0F0D 0%, #3A1510 50%, #2A0F0D 100%)",
      ...
      {loaded && item.caption && (
        <div
          ...
          style={{
            ...
            background:
              "linear-gradient(to top, rgba(22,8,7,0.85) 0%, transparent 100%)",
            opacity: 0,
...
export const PhotoGallery: React.FC = () => {
  ...
  const goNext = () =>
    setLightboxIndex((i) => (i !== null && i < preview.length - 1 ? i + 1 : i));
  ...
  .card-hover:hover .caption-overlay { 
    opacity: 1 !important; 
  }
...
`}</style>
      ...
      <div style={{ maxWidth: "var(--container-max)", margin: "0 auto" }}>
        ...
        {hasMore && (
          ...
          >
            ...
            >
              Showing{" "}
              <strong style={{ color: "#C96A3A" }}>{HOME_PREVIEW_LIMIT}</strong>{" "}
              of{" "}
              <strong style={{ color: "#C96A3A" }}>
      ...
      {lightboxIndex !== null && preview[lightboxIndex] && (
        <Lightbox
          item={preview[lightboxIndex]}
          onClose={closeLightbox}
          onPrev={goPrev}
          onNext={goNext}
          hasPrev={lightboxIndex > 0}
          hasNext={lightboxIndex < preview.length - 1}
        />
      )}
    </section>
  );
