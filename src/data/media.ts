...
export const galleryImages: ImageItem[] = [
  {
    id: 'img-001',
    src: 'https://drive.google.com/uc?export=edit&id=1nCeCW9Z_PfPBR7rIHoSNmF2N49EtIxmX',
    alt: 'Haji Lane street art',
    category: 'haji-lane',
    caption: 'Colourful murals along Haji Lane',
  },
  {
    id: 'img-002',
    src: 'https://drive.google.com/thumbnail?id=1nCeCW9Z_PfPBR7rIHoSNmF2N49EtIxmX&sz=s1600',
    alt: 'Group 5 at Haji Lane',
    category: 'group',
    caption: 'PGDM Group 5 together at Haji Lane',
  },
  {
    id: 'img-003',
    src: 'https://drive.google.com/uc?export=edit&id=1osqRWU2fksNp7vVIwcCZukIDz9Wckvoq',
    alt: 'Team activity',
    category: 'activity',
    caption: 'Team activity during the outdoor programme',
  },
  {
    id: 'img-004',
    src: 'https://drive.google.com/uc?export=view&id=REPLACE_WITH_FILE_ID',
    alt: 'Kampong Glam',
    category: 'haji-lane',
